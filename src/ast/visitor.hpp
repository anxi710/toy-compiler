...
public:
  ...
  virtual void visit(ArrayAccess &aacc) = 0;
  virtual void visit(TupleAccess &tacc) = 0;
  virtual void visit(Number &num) = 0;
  virtual void visit(ArrayElems &arrelems) = 0;
  virtual void visit(TupleElems &tupelems) = 0;
...
public:
  ...
  void visit(ArrayAccess &aacc) override {};
  void visit(TupleAccess &tacc) override {};
  void visit(Number &num) override {};
  void visit(ArrayElems &arrelems) override {};
  void visit(TupleElems &tupelems) override {};
